...
class ReportController(http.Controller):
    ...
    def report_routes(self, reportname, docids=None, converter=None, **data):
        ...
        _logger.info(data)
        _logger.info("12312312312312312312312312321123123123123333333333333333333333333333333333333333333333333333333333")
        if docids:
        ...
        if converter == 'html':
            ...
            _logger.error("5555555555555555555555555555555555555555")
            #data['report_type'] = 'pdf'
            _logger.error(data)
            _logger.info(report.with_context(context)._render_qweb_pdf(reportname, docids, data=data)[0])
            _logger.info('77777777777777777777777777777777777777777777777777777777777777')
            #data['report_type'] = 'pdf'
        ...
        try:
            if type_ in ['qweb-pdf', 'qweb-text']:
                ...
                if docids:
                    # Generic report:
                    _logger.error("=======================================================================")
                    _logger.error("Comming1")
                    _logger.error(context)
                    response = self.report_routes(reportname, docids=docids, converter=converter, context=context)
                else:
                    _logger.error("Comming2")
                    # Particular report:
