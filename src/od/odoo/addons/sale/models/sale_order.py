...
class SaleOrder(models.Model):
    ...
    #x_studio_servido_parcialmente = fields.Selection([('Si','Servido parcialmente'),('No servido','No servido'),('No','Completado'),(u'Preparar envío',u'Preparar envío'),('Perdido','Perdido'),('Reembolsado','Reembolsado'),('Servido fungible','Completado fung>
